...
import {BoxWrapper, HeaderCheckBox, Wrapper, HeaderWrapper,HeaderNumber, HeaderTitle, HeaderDate, BodyWrapper, BodyCheckBox, BodyNumber, BodyTitle, BodyDate, HrLine, SelectEraseButtonWrapper, SelectEraseButton} from "./Board.List.styles"
export default function BoardUI(props) {
    ...
    <Wrapper>
        <BoxWrapper>
            <HeaderWrapper>
                <HeaderCheckBox type = "checkbox" id= "myCheck" checked = {props.checkedAll} onClick = {props.onClickHeaderBox}></HeaderCheckBox>
