...
import { PasswordError, EmailError, HeadTitle, ContextWrapper, EmailWrapper, EmailInput, EmailText, EmailDirectionWrapper, PasswordDirectionWrapper, PasswordWrapper, PasswordText, PasswordInput, Button, ButtonDirectionWrapper } from "../../styles/Login";
...
const LoginPage = () =>{
    ...
    const Login = () => {
        if(!email.includes("@") || pw.length < 8){
            ...
            alert("회원가입을 축하드립니다.");
            const LoginSuccess = alert("회원가입을 축하드립니다");
