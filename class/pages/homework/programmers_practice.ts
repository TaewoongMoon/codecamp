...
//     const c = parseInt(String(s.length / 2))
//     return s[c]
//   }
// }
...
// function solution7(array, commands) {
//   let answer = []
...
// function solution6(arr, divisor) {
//   let answer = []

//   answer = arr
//     .filter((data) => !(data % divisor === 0))
//     .sort(function (a, b) {
//       return a - b
//     })
...
//   const answer = `김서방은 ${SeoulNumber.length}에 있다`
//   return answer
// }
